...
router
  .on("portfolio", () => {
    console.log("Navigo route matched: portfolio");
  })
  .resolve();
    ...
    formElement.addEventListener("submit", function (event) {
      ...
      if (
        ...
        errorAlert.querySelector("p").textContent =
          "Failed! Please fill in all required fields (Name, Email, Message).";
      ...
      try {
        ...
        errorAlert.querySelector("p").textContent =
          "Failed! Error checking reCAPTCHA.";
        errorAlert.style.display = "block";
        return;
      }
      ...
      if (recaptchaResponse === "") {
        ...
        errorAlert.querySelector("p").textContent =
          "Failed! Please complete the reCAPTCHA verification.";
        errorAlert.style.display = "block";
        return;
      }
